...
<div class="aside aside-left  aside-fixed  d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto " id="kt_brand">
        ...
        {{-- <a href="{{route('admin.index')}}" class="brand-logo"> --}}
            {{--			<img alt="Logo" src="{{asset('dashboard_assets/Template.png')}}" />--}}
            <h2>Template</h2>
        </a>
                ...
                <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    ...
                    <div class="menu-submenu "><i class="menu-arrow"></i>
                        <ul class="menu-subnav">
                            ...
                            {{-- <li class="menu-item " aria-haspopup="true"><a href="{{route('admin.customers.index')}}" class="menu-link "> --}}
                                <i class="menu-bullet menu-bullet-dot"><span></span></i><span class="menu-text">@lang('admin/dashboard.patients')</span></a></li>
                                <i class="menu-bullet menu-bullet-dot"><span></span></i><span class="menu-text">@lang('admin/dashboard.doctors')</span></a>
                            </li>
                        </ul>
                    </div>
                </li>
