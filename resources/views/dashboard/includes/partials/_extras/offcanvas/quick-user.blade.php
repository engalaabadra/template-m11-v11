...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
	...
	<div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
		<h3 class="font-weight-bold m-0">
            @lang('admin/dashboard.admin_profile')
		</h3>
	...
	<div class="offcanvas-content pr-5 mr-n5">
		...
		<div class="d-flex align-items-center mt-5">
			<div class="symbol symbol-100 mr-5">
				<div class="symbol-label" style="background-image:url('{{auth()->user()->photo ?? resolvePhoto(null,'admin')}}')"></div>
			...
			<div class="d-flex flex-column">
				...
				<div class="navi mt-2">
					...
					{{-- <a href="{{route('admin.logout')}}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">@lang('admin/dashboard.sign_out')</a> --}}
				</div>
			</div>
		</div>
				...
				<div class="navi-link">
					...
					<div class="navi-text">
						<div class="font-weight-bold">
							@lang('admin/dashboard.my_profile')
						</div>
						<div class="text-muted">
                            @lang('admin/dashboard.account_settings_and_more')
							<span class="label label-light-danger label-inline font-weight-bold">@lang('admin/dashboard.update')</span>
						</div>
					</div>
				</div>
			</a>
